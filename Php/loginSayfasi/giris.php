...
<html lang="en">
  ...
  <input type="text" name="kullaniciadi" class="form-control" placeholder="Kullanıcı adı" aria-describedby="basic-addon1">
        ...
        <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">@</span>
  <input type="text" name="sifre" class="form-control" placeholder="Şifre" aria-describedby="basic-addon1">
</div>
        <div class="checkbox">
          <label>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit">Şifremi unuttum</button>
      </form>
